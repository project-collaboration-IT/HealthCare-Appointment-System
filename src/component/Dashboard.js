  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-light text-gray-800">
              <span className="whitespace-nowrap">{text.welcome}, {userData.firstName}!</span>
            </h1>
          </div>
              ...
              <div className="p-6 border-t border-gray-200">
                ...
                <div className="flex flex-col space-y-3 sm:hidden">
                  <button
                    ...
                    disabled={isLoading}
                    className="w-full px-4 py-2 border-2 border-red-500 text-red-500 rounded-lg hover:bg-red-50 transition-colors flex items-center justify-center space-x-2 disabled:opacity-50"
                  >
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {/* Contact Us Section - Mobile and Desktop */}
        <div className="mt-8 flex justify-center px-4">
          <button
            onClick={() => setShowContact(true)}
            className="w-full sm:w-auto px-6 sm:px-8 py-3 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors flex items-center justify-center space-x-2"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
            </svg>
